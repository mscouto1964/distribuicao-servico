...
# ======================================================
# Helpers: robust CSV reader + normalizers
# ======================================================
...
# ======================================================
# Defaults (apenas para arrancar sem uploads)
# ======================================================
...
# ======================================================
# Sidebar: lista de docentes + TE global + modo
# ======================================================
...
# ======================================================
st.markdown("---")
st.header("Cargas por docente, regras e semáforo")
...
st.dataframe(
    base_c[["docente_id","nome","grupo","letiva_atr_min","alvo_letiva_min","reducao79_min","te_atr_min","te_alvo_min","semaforo","estado"]]
